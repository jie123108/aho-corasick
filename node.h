...
struct edge
{
	AC_ALPHABET_UTF8_T alpha; /* Edge alpha */
	struct node * next; /* Target of the edge */
};


AC_NODE_t * node_create            (void);
AC_NODE_t * node_create_next       (AC_NODE_t * thiz, AC_ALPHABET_UTF8_T alpha);
void        node_register_matchstr (AC_NODE_t * thiz, AC_PATTERN_t * str);
void        node_register_outgoing (AC_NODE_t * thiz, AC_NODE_t * next, AC_ALPHABET_UTF8_T alpha);
AC_NODE_t * node_find_next         (AC_NODE_t * thiz, AC_ALPHABET_UTF8_T alpha);
AC_NODE_t * node_findbs_next       (AC_NODE_t * thiz, AC_ALPHABET_UTF8_T alpha);
